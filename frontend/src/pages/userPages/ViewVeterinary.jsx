...
import { Box, Card, CardContent, Typography, CircularProgress, Grid, Alert, Chip, Avatar, Tooltip, TextField, InputAdornment, Button } from "@mui/material";
    ...
    const fetchVeterinarians = async () => {
      try {
        ...
        if (response.status === 200) {
          console.log('fetched veterinary details',response)
        ...
        console.log('Error fetching veterinary data:',err)
        setLoading(false);
      }
    };
    ...
    <>
      ...
      <Box sx={{ minHeight: "100vh", py: 4 }}>
        <Typography variant="h4" fontWeight={600} align="center"  >
          Best Veterinary🧑‍⚕️Clinics for All Your Pet Needs
        </Typography>
        <Typography variant="h6" my={2} textAlign="center" color="gray">
          Explore our trusted network of veterinary professionals and find the perfect care partner for your pet’s health and happiness
        </Typography>
